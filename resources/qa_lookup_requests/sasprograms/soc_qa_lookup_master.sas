...
*
* PURPOSE:  To create lookup tables for the SCDM QA data checking package version 8.x.x
*
*
* MAJOR STEPS:
...
*  Last modified date (mm/dd/yy): 04/17/2024
*
*****************************************************************************************/
/* Edit macro variable to point to the root directory */
/**  Example:  %let in= U:\dev\test\qa_lookup\; **/
%let root= ;
/****************************************************************************************/
...
*----------------------------------------------------------------------------------------;
/**********************************************************************/
/* Edit macro variable to point to most recent SAS zipcode input file */
/**  Example: Oct16_v9 **/
%let version=Apr22_v9;
/**********************************************************************/
...
%include "&INFOLDER.\01.1_create_lookup_tables.sas" / source2 ;
